...
SRC_URI = "https://github.com/at-wat/neonavigation-release/archive/release/melodic/joystick_interrupt/0.4.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "751163cdd461fee433fdc1b81d7b332e"
SRC_URI[sha256sum] = "0bbaa6c21924fa160e9e6d11087ec8ee13db29bf05fe9d6b87a1db6ccc82f126"
S = "${WORKDIR}/neonavigation-release-release-melodic-joystick_interrupt-0.4.2-1"
