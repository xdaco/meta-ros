...
SRC_URI = "https://github.com/ros-gbp/vrx-release/archive/release/melodic/wave_gazebo_plugins/1.2.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "5377d4a3cecdffaa96b3ac701ccc6960"
SRC_URI[sha256sum] = "42eebc623e7a7594a1c18a5df539fce0bc65ae3793262290a28bc2a88a53c9dc"
S = "${WORKDIR}/vrx-release-release-melodic-wave_gazebo_plugins-1.2.2-1"
