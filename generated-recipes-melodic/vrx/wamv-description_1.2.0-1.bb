...
SRC_URI = "https://github.com/ros-gbp/vrx-release/archive/release/melodic/wamv_description/1.2.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "63885184b6aa75c7536263586e357cd0"
SRC_URI[sha256sum] = "b6f0faafe0b8f12a075cd37d788f27a5629927e905b6eae8a6475f2c31abe98e"
S = "${WORKDIR}/vrx-release-release-melodic-wamv_description-1.2.0-1"
