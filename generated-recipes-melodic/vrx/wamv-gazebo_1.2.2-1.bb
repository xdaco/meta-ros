...
SRC_URI = "https://github.com/ros-gbp/vrx-release/archive/release/melodic/wamv_gazebo/1.2.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "8cf41e816683d4af504d2d409f8bbf5c"
SRC_URI[sha256sum] = "173c21f18a212580d7e061c65501404bc698161510aeeed615dd49deee8ee58c"
S = "${WORKDIR}/vrx-release-release-melodic-wamv_gazebo-1.2.2-1"
