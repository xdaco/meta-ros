...
SRC_URI = "https://github.com/PilzDE/pilz_robots-release/archive/release/melodic/pilz_testutils/0.5.7-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "8a090d1ac727b8fe3dd07c825223fe39"
SRC_URI[sha256sum] = "f1abb291a91b7be68b02737c099de6883ee8be97908219564453f621217a3538"
S = "${WORKDIR}/pilz_robots-release-release-melodic-pilz_testutils-0.5.7-1"
