...
SRC_URI = "https://github.com/swri-robotics-gbp/marti_common-release/archive/release/melodic/swri_opencv_util/2.9.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
