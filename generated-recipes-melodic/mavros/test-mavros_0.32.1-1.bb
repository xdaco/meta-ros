...
SRC_URI = "https://github.com/mavlink/mavros-release/archive/release/melodic/test_mavros/0.32.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "b94d62debb8cf4c190da25a5d2d66a81"
SRC_URI[sha256sum] = "6a9c794b01c2dd3e20db9f21e76b36bc31ff056a233359ce40c79a5ea778b911"
S = "${WORKDIR}/mavros-release-release-melodic-test_mavros-0.32.1-1"
