...
SRC_URI = "https://github.com/mavlink/mavros-release/archive/release/melodic/libmavconn/0.32.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "1ccafda4470985df734e0d60ad8fa8ca"
SRC_URI[sha256sum] = "01b98c986060b0b1b69ef5cbd71cc1f44eb0488741108d362eea5ec55c019c83"
S = "${WORKDIR}/mavros-release-release-melodic-libmavconn-0.32.1-1"
